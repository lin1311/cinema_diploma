document.addEventListener('DOMContentLoaded', function() {
    ...
    let priceDrafts = {};
    window.priceDraftsLocal = priceDrafts;
    ...
    window.getPriceDrafts = readPriceDrafts;
    window.clearPriceDraftForHall = clearDraftForHall;
    ...
    // ======== Удалить зал из всех блоков ========
        function removeHallFromUI(hallId) {
            clearDraftForHall(String(hallId));
        ...
        if (pricesForm) {
            ...
            pricesForm.addEventListener('submit', function(event) {
                    ...
                    fetch(pricesForm.action, {
                        ...
                        .catch((error) => {
                            const fallback = 'Не удалось сохранить цены.';
