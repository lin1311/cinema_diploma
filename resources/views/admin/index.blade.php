  ...
  <main class="conf-steps">
          ...
          @if ($movies->count())
            @foreach ($movies as $movie)
              <div class="conf-step__movie" data-id="{{ $movie->id }}">
                <img class="conf-step__movie-poster" alt="poster" src="{{ $movie->poster_url ?: asset('assets/admin/i/poster.png') }}">
    ...
    <section class="conf-step">
      ...
      <div class="conf-step__wrapper text-center">
        <p id="publish-sales-hint" class="conf-step__paragraph">{{ !empty($salesOpen) ? 'Чтобы внести измения надо:' : 'Всё готово, теперь можно:' }}</p>
        <button id="publish-sales-btn" class="conf-step__button conf-step__button-accent">{{ !empty($salesOpen) ? 'Закрыть продажи' : 'Открыть продажи' }}</button>
...
@section('modals')
  ...
  @include('admin.popup_update-poster')
...
@push('scripts')
  ...
  <script> window.salesOpenFromServer = @json(!empty($salesOpen))</script>
  ...
  <script src="{{ asset('assets/admin/js/popup-film-poster.js') }}"></script>
