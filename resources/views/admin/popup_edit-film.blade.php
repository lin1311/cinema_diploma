        ...
        <div class="popup__content">
            ...
            <div class="popup__wrapper">
                <form id="edit-movie-form" action="" method="POST">
                    ...
                    <input type="hidden" name="poster_url" id="edit-movie-poster-url">
                    <input type="hidden" name="poster_original_name" id="edit-movie-poster-original-name">
                    ...
                    <div class="conf-step__poster-actions-row">
                        <div class="conf-step__poster-actions-left">
                            <p class="conf-step__poster-link-line">
                                <a href="#" id="edit-movie-upload-poster-link">загрузить постер</a>
                            </p>
                            <p id="edit-movie-poster-file-name" class="conf-step__poster-file-name" hidden></p>
                        </div>
                        <div class="conf-step__buttons text-center conf-step__poster-actions-buttons">
