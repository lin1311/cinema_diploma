    ...
    <div class="popup__content">
      ...
      <div class="popup__wrapper">
        <form action="{{ route('movies.store') }}" method="POST" accept-charset="utf-8">
          @csrf
          <input type="hidden" name="poster_url" id="add-movie-poster-url">
          <input type="hidden" name="poster_original_name" id="add-movie-poster-original-name">
          ...
          <div class="conf-step__poster-actions-row">
            <div class="conf-step__poster-actions-left">
              <p class="conf-step__poster-link-line">
                <a href="#" id="add-movie-upload-poster-link">загрузить постер</a>
              </p>
              <p id="add-movie-poster-file-name" class="conf-step__poster-file-name" hidden></p>
            </div>
